...
indicators1_solo_trends = [{"5": "Upper Danger"},
                           {"5&uptrend": "Upper Danger + uptrend"},
                           {"5&downtrend": "Upper Danger + downtrend"},
                           {"5&BULL": "Upper Danger + BULL"},
                           {"5&BEAR": "Upper Danger + BEAR"},
                           # {"4":"Huge Fall Turnaround"},
                           {"3": "Long Uptrend"},
                           {"3&uptrend": "Long Uptrend + uptrend"},
                           {"3&downtrend": "Long Uptrend + downtrend"},
                           {"3&BULL": "Long Uptrend + BULL"},
                           {"3&BEAR": "Long Uptrend + BEAR"},
                           # {"2": "Downtrend Upswing"},
                           # {"1":"Small Upswing"},
                           {"0": "Normal"},
                           {"0&uptrend": "Normal + uptrend"},
                           {"0&downtrend": "Normal + downtrend"},
                           {"0&BULL": "Normal + BULL"},
                           {"0&BEAR": "Normal + BEAR"},
                           {"-1": "Slow Downtrend"},
                           {"-1&uptrend": "Slow Downtrend + uptrend"},
                           {"-1&downtrend": "Slow Downtrend + downtrend"},
                           {"-1&BULL": "Slow Downtrend + BULL"},
                           {"-1&BEAR": "Slow Downtrend + BEAR"},
                           {"-2": "Long Downtrend"},
                           {"-2&uptrend": "Long Downtrend + uptrend"},
                           {"-2&downtrend": "Long Downtrend + downtrend"},
                           {"-2&BULL": "Long Downtrend + BULL"},
                           {"-2&BEAR": "Long Downtrend + BEAR"},
                           {"-3": "Bottom Danger"},
                           {"-3&uptrend": "Bottom Danger + uptrend"},
                           {"-3&downtrend": "Bottom Danger + downtrend"},
                           {"-3&BULL": "Bottom Danger + BULL"},
                           {"-3&BEAR": "Bottom Danger + BEAR"},
                           ]
...
indicators3_list  = [   {"---FAVORITES---":""},
                        ...
                        {"Vol Generalized":"vol_gen_a vol_gen_b vol_gen_c vol_mult"},
                        {"---VOLATILITY---":""},
                        {"Volatility":"vol50 vol100 vol175 vol250"},
                        {"Mid Volatility":"vol500 vol1000 volultra"},
                        {"High Volatility":"volultra vol1000"},
                        {"---VOL GENERALIZED---":""},
                        {"Short-Med (reactive)":"vol_gen_a"},
                        {"Long-Term (structural)":"vol_gen_b"},
                        {"Ultra (volultra-based)":"vol_gen_c"},
                        {"Percentile Rank (-100/100)":"vol_mult"},
                        {"All Together":"vol_gen_a vol_gen_b vol_gen_c vol_mult"},
                        {"Convergence":"convsmall convmedium"},
